      ...
      <div className="premium-card relative flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-[1.75rem]">
        <div className="flex flex-col gap-4 border-b border-white/10 bg-[#0b0d12]/88 p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <a href={resumePath} target="_blank" rel="noreferrer" className="focus-ring inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-white/10 bg-white/8 px-4 text-sm font-medium text-white transition hover:bg-white/[0.12]">
              <ExternalLink size={16} /> Open PDF
            </a>
            <a href={resumePath} download className="focus-ring inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-white px-4 text-sm font-medium text-slate-950 transition hover:bg-cyan-100">
        ...
        <div className="min-h-[65vh] bg-slate-950 sm:min-h-[72vh]">
          <object data={resumePath} type="application/pdf" className="h-[65vh] w-full sm:h-[72vh]" aria-label="Resume PDF preview">
            <div className="flex h-full flex-col items-center justify-center gap-4 p-6 text-center text-slate-300">
              ...
              <a href={resumePath} target="_blank" rel="noreferrer" className="focus-ring inline-flex min-h-11 items-center justify-center rounded-full bg-white px-4 font-medium text-slate-950">Open resume PDF</a>
            </div>
          </object>
        </div>
      </div>
