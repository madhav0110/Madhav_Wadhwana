  ...
  return (
    <section className="section-shell section-pad">
      <Reveal className="premium-card overflow-hidden rounded-[2rem] p-6 sm:p-10 lg:p-14">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-stone-700">My direction is applied AI: intelligent SaaS tools, ML-powered workflows, secure automation systems, and interfaces that help people act on complex data.</p>
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {interests.map((interest) => <div key={interest} className="rounded-2xl border border-stone-900/15 bg-[#fffaf0]/70 px-4 py-4 font-mono text-sm text-stone-700">{interest}</div>)}
        </div>
      </Reveal>
    </section>
  )
